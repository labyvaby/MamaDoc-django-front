 ...
 *
 * Бэкенд выложен на прод 09.09.2026 — модуль работает на живом API. Моки ниже
 * (см. WAITLIST_USE_MOCKS) оставлены для локальной отладки без бэкенда.
 */

/** true — данные из памяти вкладки; false — живой API. */
export const WAITLIST_USE_MOCKS = false;
