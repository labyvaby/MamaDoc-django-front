 ...
 *
 * Включён 09.09.2026: бэкенд выложен на прод — под сессией на
 * `newcrm.pediatr.kg` все ручки отвечают 200, воронка «Первичные обращения»
 * и справочники засеяны, права `deals.*` лежат на ролях, `deals` есть в
 * `enabledModules`. ⚠ Без авторизации ручки дают 401, а несуществующий путь —
 * 404: анонимным curl-ом «выложено или нет» не проверить.
 */
export const DEALS_MODULE_ENABLED = true;
