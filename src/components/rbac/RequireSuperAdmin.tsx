 ...
 * организации не должна её видеть. Сейчас так закрыта «Сводка» (решение
 * заказчика 27.08.2026) — в отличие от RequirePermission, здесь нет
 * permission-кода, который организация могла бы выдать себе в редакторе ролей.
 * Исторические реестры «Все приёмы» / «Все процедуры» этим гейтом закрывались
 * с 19.08.2026, теперь у них обычное page-visibility право.
 *
 * @example
 * <RequireSuperAdmin>
 *   <DashboardPage />
