...
/**
 * Пункт списка ЛИС начинается с дефиса-минуса и пробела. Именно дефиса:
 * тире « — » ЛИС ставит внутри фраз («желательно — не менее 12 часов»),
 * а «кон-ия» без пробела — не пункт.
 */
const BULLET = /(?:^|\s)-\s+/;
