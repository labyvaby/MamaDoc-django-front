...
export interface BasketLine {
  ...
  express: boolean;
  /**
   * Приносной: пациент принёс биоматериал сам (моча, кал, соскоб в своей
   * таре). Пробирки и услуга взятия под такой анализ не нужны — в набор
   * не идут и с пациента не берутся.
   */
  broughtIn: boolean;
}
