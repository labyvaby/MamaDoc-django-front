 ...
 *
 * Отдельно от товаров визита (`AppointmentProductLines`) намеренно: расходники
 * не попадают в чек и пациент за них не платит — их стоимость уже внутри цены
 * услуги. Поэтому суммы здесь не показываем вообще, только количество и остаток
 * склада филиала.
 *
