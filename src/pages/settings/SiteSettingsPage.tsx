 ...
 * поле, чтобы не ждать миграции на бэке. Отсюда же важное ограничение: гость
 * увидит правки, только когда бэк начнёт отдавать `landing` в публичном ответе
 * `/api/v1/organizations/<slug>/` (тикет
 * `MamaDoc/backend_ticket_public_landing.md`). До тех пор кнопка
 * «Предпросмотр» показывает страницу с правками в этой вкладке, а гость видит
 * версию, собранную из данных CRM. Об этом честно сказано плашкой на странице,
