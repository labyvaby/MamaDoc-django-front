...
const DjangoSalaryReportsPage: React.FC = () => {
  ...
  // конкретный филиал — живой срез (приёмы, авансы и часы смен этого филиала).
  // Часы берутся по WorkShift.branch, поэтому смена без филиала видна только в
  // режиме «Все филиалы». Заморозка в срезе недоступна.
