...
// Since we are reusing logic, let's create a readonly view of appointment details
// or reuse AppointmentDetailsCard if it supports readonly mode.
// For now, a custom simple read-only view.
...
export const HistoryDetailsModal: React.FC<HistoryDetailsModalProps> = ({ open, onClose, appointmentId }) => {
    const theme = useTheme();
    const fullScreen = useMediaQuery(theme.breakpoints.down('md'));
    const { item, appointmentDoctors, servicesPhotos, loading } = useAppointmentDetails(open ? appointmentId : null);
